<template>
      ...
      <el-aside width="sideWidth +'px'" style="background-color: rgb(238, 241, 246); height: 100%; box-shadow: 2px 0 6px rgb(0 21 41 / 35%);">
        ...
        <div style="height: 60px; line-height: 60px; text-align:center">
          <img src="../assets/logo.png" style="width:20px; position: relative; top:5px; margin-right: 5px; margin-left: 6px;">
          <b style="color:white; margin-right: 5px;" v-show="textShow">教务管理系统</b>
        </div>
          <el-submenu index="1">
            <template slot="title">
